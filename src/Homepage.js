  ...
  <div
        ...
        >
          ...
          <Avatar size={{
            ...
            xl: 160,
            xxl: 200,
          }} icon={<Image style={{width: 200}} src='/profile.JPEG'/> } />
            <Title level={1}>Nakeisya Rahma Nurramadhan</Title>
            <Text align='center'>Saya merupakan lulusan baru dari SMK Jurusan 
Multimedia. Dengan Pengalaman dokumentasi berbagai Event. Berkat hasil kerja keras saya, saya juga berhasil Lulus dengan Nilai rapot 83,04, Saya juga sudah mengikuti beberapa lomba membuat video iklan.</Text>
          </Flex>
        ...
        <Title level={2} align='center'>Skills</Title>
        <List
          align='center'
          grid={{
            gutter: 16,
              ...
              items={[
                {
                  ...
                  description: <>Saya mempunyai pengalaman praktik kerja lapangan di Shine Visuals Studio selama 6 bulan
                  sebagai Fotografer dan Editor Video, disana saya berhasil memperoleh nilai akhir 89,54<br/>2023</>,
                },
              ]}
                />
